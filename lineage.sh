git clone https://github.com/dinosnore1/device_xiaomi_kenzo -b los-15.1 device/xiaomi/kenzo
git clone https://github.com/dinosnore1/device_xiaomi_msm8956-common -b los-15.1 device/xiaomi/msm8956-common
