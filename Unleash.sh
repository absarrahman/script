git clone https://github.com/absarrahman/device_xiaomi_kenzo -b Unleash device/xiaomi/kenzo
git clone https://github.com/absarrahman/device_xiaomi_msm8956-common -b Unleash device/xiaomi/msm8956-common
