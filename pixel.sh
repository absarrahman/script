...
git clone https://github.com/absarrahman/device_xiaomi_msm8956-common -b 8.1 device/xiaomi/msm8956-common
git clone https://github.com/dinosnore1/kernel_xiaomi_msm8956 -b oreo kernel/xiaomi/msm8956
