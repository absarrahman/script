git clone https://github.com/shamith16/android_device_xiaomi_kenzo -b 8.1 device/xiaomi/kenzo
git clone https://github.com/shamith16/device_xiaomi_msm8956-common -b 8.1t device/xiaomi/msm8956-common
git clone https://github.com/shamith16/kernel_xiaomi_msm8956 -b 8.1 kernel/xiaomi/msm8956
git clone https://github.com/shamith16/proprietary_vendor_xiaomi -b 8.1 vendor/xiaomi
...
git clone https://github.com/shamith16/android_external_ant-wireless_antradio-library -b staging/lineage-15.1 external/ant-wireless/antradio-library
